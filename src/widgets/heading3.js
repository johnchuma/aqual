...
const Heading3 = ({fontWeight,fontSize,color,text,className,...style}) => {
    return (
        <>
          <animated.div className={className+` d-none d-md-block `} style={{...style,fontWeight:fontWeight??900,fontFamily:"valeria", lineHeight:1.2, fontSize:fontSize??"1.3vw",color:color??textColor}}   
